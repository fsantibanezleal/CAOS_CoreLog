  ...
  return (
    <article className="page-body prose">
      ...
      <Callout variant="strong" title={es ? 'Toda la CV corre EN VIVO en tu browser' : 'All the CV runs LIVE in your browser'}>
        {es
          ? 'El generador de bandejas, la segmentación run-merge y el clasificador corren en TypeScript en el browser; el CNN de litología corre vía onnxruntime-web. Seleccionar un caso y la segmentación se recalcula al instante. (La carga de tu propia bandeja en la app aún no está implementada.)'
