// Live in-browser inference of the lithology CNN (onnxruntime-web). GRACEFUL: until the model is trained
// (science/train_litho.py → lithology-cnn.onnx), the file is absent; the loader resolves to null and the App falls
// back to the classical baseline + shows the honest "pending training" state. The npm package and the CDN wasmPaths
