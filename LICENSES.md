...
CoreLog Vision itself is MIT ([LICENSE](LICENSE)). It builds on these components, each under its own license.
...
| [onnxruntime-web](https://onnxruntime.ai) | MIT | live in-browser CNN + OOD inference |
| [µPlot](https://github.com/leeoniya/uPlot) | MIT | charts |
...
| [PyTorch](https://pytorch.org) | BSD-3-Clause | training the CNN + the OOD AE (`--retrain`, local only) |
...
No third-party data is redistributed, the core-tray images are synthetic, generated by the seeded TS engine.
