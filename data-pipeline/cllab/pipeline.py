...
the compact artifact + manifest (CONTRACT 2) and a flat index.json.
    ...
    python -m cllab.pipeline            # all cases
    python -m cllab.pipeline EX02_epidemic --seed 7
"""
...
# data-pipeline/cllab/pipeline.py -> parents[2] = repo root (works under `pip install -e .` too)
