...
All notable changes to this product. Format: `X.XX.XXX` (display) — see `cllab.__version__`. Keep `0.x`
...
- Offline `data-pipeline/` (`cllab`): the two data contracts (ingestion + artifact), the named staged
